...
(function() {
			...
			.extend(
					...
					Events,
					{
						...
						set : function(models, options) {
							...
							// from being added.
							for (i = 0, l = models.length; i < l; i++) {
								if (!(model = this._prepareModel(models[i],
										options)))
									continue;
						...
						get : function(obj) {
							if (obj == null)
								return void 0;
							return this._byId[obj.id != null ? obj.id : obj.cid
									|| obj];
						},
	...
	var methods = [ 'forEach', 'each', 'map', 'collect', 'reduce', 'foldl',
			...
			'without', 'indexOf', 'shuffle', 'lastIndexOf', 'isEmpty', 'chain' ];
						...
						start : function(options) {
							...
							if (this._wantsHashChange && this._wantsPushState
								...
								// in a browser where it could be `pushState`-based instead...
									...
									&& this._hasPushState && atRoot && loc.hash) {
